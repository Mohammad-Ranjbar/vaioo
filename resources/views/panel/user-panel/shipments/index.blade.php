        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                    ...
                    <div>
                        <a class="card-title btn btn-info" href="{{route('user.shipments.create')}}">
                            ایجاد محموله
                        </a>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            ...
                                            <a class="btn btn-soft-info btn-sm"
                                               href="{{route('user.shipments.show',$shipment->id)}}">
                                                <iconify-icon class="align-middle fs-18"
                                            ...
                                            <div class="modal fade" id="deleteModal{{$shipment->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{route('user.shipments.destroy',$shipment->id)}}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')

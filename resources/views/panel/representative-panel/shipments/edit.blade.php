        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('representative.shipments.update', $shipment->id) }}" method="post" role="form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" dir="rtl" id="sender_name" name="sender_name" readonly disabled
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" dir="ltr" id="sender_phone" name="sender_phone" readonly disabled
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" dir="rtl" id="reciver_name"  readonly disabled
                                           class="form-control text-right @error('reciver_name') is-invalid @enderror"
                                           value="{{ old('reciver_name', $shipment->reciver_name) }}" required>
                                    @error('reciver_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" dir="ltr" id="reciver_phone"  readonly disabled
                                           class="form-control text-left @error('reciver_phone') is-invalid @enderror"
                                           value="{{ old('reciver_phone', $shipment->reciver_phone) }}" required>
                                    @error('reciver_phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" id="weight"  readonly disabled
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="declared_value"  readonly disabled
                        ...
                        <div class="mb-3">
                            ...
                            <textarea dir="rtl" id="description" readonly disabled

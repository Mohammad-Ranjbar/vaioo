            ...
            <div class="col-xl-6">
                <div class="card auth-card">
                    ...
                    <div class="card-body px-3 py-5">
                        ...
                        <div class="px-4">
                            <form action="{{route('representative.register')}}" method="post" role="form" class="authentication-form" id="registerForm">
                                @csrf

                                <!-- اطلاعات شخصی -->
                                <div class="row mb-4">
                                    <h6 class="text-muted mb-3 border-bottom pb-2">اطلاعات شخصی</h6>
                                ...
                                <!-- اطلاعات هویتی -->
                                <div class="row mb-4">
                                    <h6 class="text-muted mb-3 border-bottom pb-2">اطلاعات هویتی</h6>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label" for="national_code">
                                            کد ملی <span class="text-danger">*</span>
                                        </label>
                                        <input class="form-control bg-light bg-opacity-50 border-light py-2 text-center @error('national_code') is-invalid @enderror"
                                               required id="national_code" name="national_code"
                                               value="{{ old('national_code') }}"
                                               placeholder="۰۹۲۱۱۲۳۴۵۶" maxlength="10"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control bg-light bg-opacity-50 border-light py-2 @error('passport_number') is-invalid @enderror"
                                               id="passport_number" name="passport_number"
                                               value="{{ old('passport_number') }}"
                                               placeholder="اختیاری - در صورت داشتن پاسپورت" />
                                ...
                                <div class="mt-3 text-center">
                                    <p class="mb-0">
                                        ...
                                        <a href="{{route('representative.login')}}" class="text-danger fw-medium">
                                            ورود به پنل
                                        </a>
                                    </p>
                                </div>

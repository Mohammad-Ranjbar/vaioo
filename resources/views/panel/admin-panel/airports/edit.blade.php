            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-1 anchor" id="basic">
                        ویرایش فرودگاه - {{ $airport->name_fa }}
                    </h5>
                    <hr>

                    <form action="{{ route('admin.airports.update', $airport->id) }}" method="post" role="form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" dir="rtl" id="name_fa" name="name_fa"
                                   ...
                                   value="{{ old('name_fa', $airport->name_fa) }}" required>
                            @error('name_fa')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" dir="ltr" id="name_en" name="name_en"
                                   ...
                                   value="{{ old('name_en', $airport->name_en) }}" required>
                            @error('name_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" dir="ltr" id="code" name="code"
                                   ...
                                   value="{{ old('code', $airport->code) }}" style="text-transform: uppercase;"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('is_active') is-invalid @enderror"
                                ...
                                <option value="1" {{ old('is_active', $airport->is_active) == 1 ? 'selected' : '' }}>فعال</option>
                                <option value="0" {{ old('is_active', $airport->is_active) == 0 ? 'selected' : '' }}>غیرفعال</option>
                            </select>
                            @error('is_active')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror

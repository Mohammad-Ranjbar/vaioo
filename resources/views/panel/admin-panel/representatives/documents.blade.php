        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.representatives.documents.create', $representative->id) }}" method="post" role="form" enctype="multipart/form-data">
                        @csrf
                    ...
                    @if($representative->hasMedia('national_card_front'))
                        <form id="delete-national_card_front"
                              action="{{ route('admin.representatives.documents.destroy', [$representative->id, 'national_card_front']) }}"
                    ...
                    @if($representative->hasMedia('national_card_back'))
                        <form id="delete-national_card_back"
                              action="{{ route('admin.representatives.documents.destroy', [$representative->id, 'national_card_back']) }}"
                              method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                    ...
                    @if($representative->hasMedia('selfie_with_card'))
                        <form id="delete-selfie_with_card"
                              action="{{ route('admin.representatives.documents.destroy', [$representative->id, 'selfie_with_card']) }}"
                              method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
